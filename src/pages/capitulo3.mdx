...
<EquationBox>
  <Equation id="3.21">
    <span>Fe(s) → Fe<sup>2+</sup>(aq) + 2e<sup>-</sup></span>
  </Equation>
</EquationBox>
...
<EquationBox>
  <Equation id="3.22">
    <span>C<sub>2</sub>HCl<sub>2</sub>(aq) → C<sub>2</sub>H<sub>4</sub>(aq) + 3Cl<sup>-</sup>(aq)</span>
  </Equation>
</EquationBox>
...
<EquationBox>
  <Equation id="3.23">
    <span>C<sub>2</sub>HCl<sub>2</sub>(aq) + 3H<sub>2</sub>O(l) + 6e<sup>-</sup> → C<sub>2</sub>H<sub>4</sub>(aq) + 3Cl<sup>-</sup>(aq) + 3OH<sup>-</sup>(aq)</span>
  </Equation>
</EquationBox>
...
<EquationBox>
  <Equation id="3.24">
    <span>3Fe(s) + C<sub>2</sub>HCl<sub>2</sub>(aq) + 3H<sub>2</sub>O(l) → 3Fe<sup>2+</sup>(aq) + C<sub>2</sub>H<sub>4</sub>(aq) + 3Cl<sup>-</sup>(aq) + 3OH<sup>-</sup>(aq)</span>
  </Equation>
</EquationBox>
